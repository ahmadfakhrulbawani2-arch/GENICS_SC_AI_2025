...
2. Copy paste everything in main.py
3. If you want to change or customize the program, You can customize according to my comment line
4. Copy everything in training-code.xml. It's open source you can find all version here: https://github.com/opencv/opencv/tree/master/data/haarcascades
5. Change The reference of training-code.xml (if you save in the same folder of main.py you can leave it as is).
6. To run open VSCode Terminal or your default terminal. Make sure you open the main.py folder! Then write: 
                    py main.py
